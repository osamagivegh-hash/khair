...
async function main() {
  ...
  const slides = [
    ...
    },
    {
      ...
      imageUrl: 'https://images.unsplash.com/photo-1591604129939-f1efa4d9f7fa?q=80&w=1770&auto=format&fit=crop', // Beautiful mosque
      order: 3,
    },
    {
      title: 'كسوة الشتاء',
      subtitle: 'لمسة دفء تحمي الأسر المتعففة واللاجئين من برد الشتاء القارس',
      imageUrl: 'https://images.unsplash.com/photo-1578632292335-df3abbb0d586?q=80&w=1774&auto=format&fit=crop', // Winter clothes/coats
      order: 4,
    },
    {
      title: 'الإغاثة العاجلة',
      subtitle: 'نقف بجانب المتضررين في الأزمات والكوارث لتقديم العون الفوري',
      imageUrl: 'https://images.unsplash.com/photo-1488521787991-ed7bbaae773c?q=80&w=1770&auto=format&fit=crop', // Humanitarian aid/boxes
      order: 5,
    },
  ]
